...
python ./manage.py dumpdata marathon_announcement --indent 4 --output marathon_announcement\fixtures\initial_data.json
python ./manage.py dumpdata marathon_chronotrack --indent 4 --output marathon_chronotrack\fixtures\initial_data.json
